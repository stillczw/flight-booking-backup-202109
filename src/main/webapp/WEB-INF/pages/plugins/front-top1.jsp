...
<div class="layui-col-md12">
    <ul class="layui-nav" lay-filter="">
        <li class="layui-nav-item layui-this layui-col-md-offset1"><a href="<%=basePath%>index.html">Activities</a></li>
        <li class="layui-nav-item"><a href="<%=basePath%>ticket/showUrl.html">Booking</a></li>
