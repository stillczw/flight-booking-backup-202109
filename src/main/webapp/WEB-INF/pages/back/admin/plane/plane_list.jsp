...
<head>
    ...
    <script src="<%=basePath%>js/plane/list.js"></script>
</head>
...
<div class="layui-layout layui-layout-admin">
    ...
    <script type="text/html" id="status">
        {{# if(d.status == 1){ }}
        <a class="layui-btn layui-btn-normal layui-btn-xs">normal</a>
        {{# }else{ }}
        <a class="layui-btn layui-btn-danger layui-btn-xs">maintenance</a>
        {{# } }}
    </script>
